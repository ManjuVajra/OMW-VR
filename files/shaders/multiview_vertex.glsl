...
//
// Your typical gl_Position line might look like the following:
...
// If someone needs access to stereo aware matrices in the fragment shader
// we need to not declare the layout
