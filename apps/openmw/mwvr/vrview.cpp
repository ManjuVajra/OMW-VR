...
//
//
//    void MyVRView::InitialDrawCallback::operator()(osg::RenderInfo& renderInfo) const
//    {
//        Environment::get().getSession()->beginPhase(VRSession::FramePhase::Draw);
//
//        osg::GraphicsOperation* graphicsOperation = renderInfo.getCurrentCamera()->getRenderer();
...
//    }
//
//    void MyVRView::UpdateSlaveCallback::updateSlave(
//        osg::View& view,
//        osg::View::Slave& slave)
//    {
//        mView->updateSlave(view, slave);
...
//    }
//
//    void MyVRView::prerenderCallback(osg::RenderInfo& renderInfo)
//    {
//        if (Environment::get().getSession()->getFrame(VRSession::FramePhase::Draw)->mShouldRender)
//            mSwapchain->beginFrame(renderInfo.getState()->getGraphicsContext());
//    }
//    void MyVRView::postrenderCallback(osg::RenderInfo& renderInfo)
//    {
//    }
//    osg::Camera* MyVRView::createCamera(int order, const osg::Vec4& clearColor, osg::GraphicsContext* gc)
//    {
//        osg::ref_ptr<osg::Camera> camera = new osg::Camera();
//        camera->setClearColor(clearColor);
//        camera->setClearMask(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
...
//    }
//
//    void MyVRView::swapBuffers(osg::GraphicsContext* gc)
//    {
//        mSwapchain->endFrame(gc);
//    }
//
//    void MyVRView::updateSlave(osg::View& view, osg::View::Slave& slave)
//    {
//        slave.updateSlaveImplementation(view);
//    }
//}
